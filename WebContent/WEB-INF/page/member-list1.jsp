                            ...
                            <table class="layui-table" lay-data="{url:'./user.json',page:true,toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
                                <thead>
                                    <tr>
                                        ...
                                        <th lay-data="{field:'username', width:120, sort: true, edit: 'text'}">商品图片</th>
                                        <th lay-data="{field:'email', edit: 'text', minWidth: 150}">商品名称</th>
                                        <th lay-data="{field:'sex', width:80,templet: '#switchTpl'}">零售价</th>
                                        <th lay-data="{field:'city', edit: 'text', minWidth: 100}">商品描述</th>
                                        <th lay-data="{field:'experience', sort: true, edit: 'text'}">库存</th>
                                        <th lay-data="{field:'dw_xinzhi',templet: function(d){ return d.dw_xinzhi.titel;}}">下架</th></tr>
                                </thead>
                            </table>
                        </div>
                    </div>
